...
public class MensajeEncriptado {
    public String desencriptar(String cifrado) {
        ...
        String retorno = String.valueOf(mensajeDesencriptado.reverse());
        return retorno;
    }
}
